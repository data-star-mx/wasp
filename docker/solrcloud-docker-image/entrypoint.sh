...
if [ $# -gt 0 ]; then
    ...
    #/solr/example/scripts/cloud-scripts/zkcli.sh -zkhost zookeeper:2118 -cmd upconfig -confdir /solr/example/solr/collection1/waspConfigSet/ -confname waspConfigSet
