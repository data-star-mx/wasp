...
case class AddRemoteProducer(override val id: String) extends ProducerMessage
case class RemoveRemoteProducer(override val id: String) extends ProducerMessage
